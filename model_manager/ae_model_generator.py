...
class AEModel(Model):
    '''This is the basic autoencoder model for benchmarking, it also serves as the backbone for the VAE and EDL'''
    def __init__(self, train_config):
        ...
        # Encoder
        self.encoder_input = layers.Input(shape=self.input_shape) #Input layer
