...
def generate_loss_vs_epoch_curve(train_config, loss, val_loss, model_type):
    plt.xlabel('Epoch')
    plt.ylabel('Loss (MSE)')
    plt.title("Loss vs epoch curve for " train_config["model_files"]["model_name"] + "_" + model_type)
